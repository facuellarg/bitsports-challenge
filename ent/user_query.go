...
func (uq *UserQuery) QueryProducts() *ProductQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2M, true, user.ProductsTable, user.ProductsPrimaryKey...),
		)
	...
	if query := uq.withProducts; query != nil {
		...
		_spec := &sqlgraph.EdgeQuerySpec{
			Edge: &sqlgraph.EdgeSpec{
				...
				Columns: user.ProductsPrimaryKey,
			},
			Predicate: func(s *sql.Selector) {
				s.Where(sql.InValues(user.ProductsPrimaryKey[1], fks...))
			},
